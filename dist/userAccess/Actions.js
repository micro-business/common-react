...
exports.signInWithFacebookSucceeded = signInWithFacebookSucceeded;
exports.signInWithFacebookFailed = signInWithFacebookFailed;
...
function signInWithFacebook(scope, userType) {
  return {
...
function signInWithFacebookSucceeded(payload) {
  return {
    type: _ActionTypes2.default.USER_ACCESS_SIGNIN_WITH_FACEBOOK_SUCCEEDED,
    payload: payload
  };
}

function signInWithFacebookFailed(payload) {
  return {
    type: _ActionTypes2.default.USER_ACCESS_SIGNIN_WITH_FACEBOOK_FAILED,
    payload: payload
  };
}
