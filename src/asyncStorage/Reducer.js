...
export default (state = initialState, action) => {
  ...
  case ActionTypes.ASYNC_STORAGE_WRITE_VALUE_SUCCEEDED:
    return state
      .setIn(['writeValueOperationsStatus', action.payload.get('operationId')], Status.SUCCEEDED)
      .setIn(['keyValues', action.payload.get('key')], action.payload.get('value'));

  case ActionTypes.ASYNC_STORAGE_WRITE_VALUE_FAILED:
    return state
      .setIn(['writeValueOperationsStatus', action.payload.get('operationId')], Status.FAILED)
  ...
  case ActionTypes.ASYNC_STORAGE_WRITE_VALUE_IN_PROGRESS:
    return state.setIn(['writeValueOperationsStatus', action.payload.get('operationId')], Status.IN_PROGRESS);
  ...
  case ActionTypes.ASYNC_STORAGE_READ_VALUE_SUCCEEDED:
    return state
      .setIn(['readValueOperationsStatus', action.payload.get('operationId')], Status.SUCCEEDED)
      .setIn(['keyValues', action.payload.get('key')], action.payload.get('value'));

  case ActionTypes.ASYNC_STORAGE_READ_VALUE_FAILED:
    return state
      .setIn(['readValueOperationsStatus', action.payload.get('operationId')], Status.FAILED)
      .deleteIn(['keyValues', action.payload.get('key')])
      .setIn(['failedOperations', action.payload.get('operationId')], action.payload);

  case ActionTypes.ASYNC_STORAGE_READ_VALUE_IN_PROGRESS:
    return state.setIn(['readValueOperationsStatus', action.payload.get('operationId')], Status.IN_PROGRESS);
